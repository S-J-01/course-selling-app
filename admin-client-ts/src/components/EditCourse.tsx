...
function EditCourse(){
    ...
    const handleNewPriceChange = (event: React.ChangeEvent<HTMLInputElement>)=>{
        setNewPrice(Number(event.target.value))
    }

    const handleNewImageLinkChange = (event: React.ChangeEvent<HTMLInputElement>)=>{
        setNewImageLink(event.target.value)
    }

    const handleNewPublishedChange = (event: React.ChangeEvent<HTMLInputElement>)=>{
        setNewPublished(Boolean(event.target.value))
    }
